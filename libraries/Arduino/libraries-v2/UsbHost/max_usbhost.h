...
#ifndef _MAX_USBHOST_H_
#define _MAX_USBHOST_H_
...
MAX3421e< SS, INTR >::MAX3421e()
{
  ...
  DDRJ |= 0x04;
  PORTJ |= 0x04;
#elif defined(USE_V1_COMPATIBLE_RESET)
  // Perform a reset with the pin used on version 1 of host shield.
  // (This should be harmless when used on version 2 of the host shield
  // as long as the pin isn't being used for something.)
#define MAX_RESET 7
